...
export function TeacherDashboard() {
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(18);
    doc.text('Success Intel – Weekly Academic Risk Report', 14, 22);
          ...
          <div className="bg-[#0f172a] border border-slate-700 rounded-xl w-full max-w-2xl shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-[#0b1220] p-4 rounded-lg border border-slate-800 space-y-2 text-sm">
                ...
                <div className="flex"><span className="text-slate-500 w-16">From:</span> <a href="mailto:alerts@successintel.ai" className="text-indigo-400 hover:underline">alerts@successintel.ai</a></div>
                <div className="flex"><span className="text-slate-500 w-16">Subject:</span> <span className="text-white font-medium">High Risk Student Alert</span></div>
              </div>
...
The Success Intel system has detected that one of your students has been classified as HIGH RISK based on academic performance indicators.
...
— Success Intel Early Warning System`}
              </div>
            </div>
      ...
      {isWeeklyEmailModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#0f172a] border border-slate-700 rounded-xl w-full max-w-2xl shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-[#0b1220] p-4 rounded-lg border border-slate-800 space-y-2 text-sm">
                <div className="flex"><span className="text-slate-500 w-16">To:</span> <span className="text-slate-300">{user?.email || 'teacher@successintel.edu'}</span></div>
                <div className="flex"><span className="text-slate-500 w-16">From:</span> <a href="mailto:reports@successintel.ai" className="text-indigo-400 hover:underline">reports@successintel.ai</a></div>
...
Here is your weekly academic risk summary generated by the Success Intel Early Warning System.
...
— Success Intel AI Academic Monitoring System`}
              </div>
            </div>
            <div className="p-4 border-t border-slate-800 flex justify-end">
