              ...
              <CardContent className="h-[250px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={attendanceData}>
                    ...
                    />
                    <Area type="monotone" dataKey="attendance" stroke="#818cf8" strokeWidth={3} fillOpacity={1} fill="url(#colorAttendance)" animationDuration={1500} />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
              ...
              <CardContent className="h-[250px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={departmentData}>
                    ...
                    <Bar dataKey="risk" name="At Risk" fill="#f87171" radius={[4, 4, 0, 0]} animationDuration={1500} />
                    <Bar dataKey="success" name="Success" fill="#34d399" radius={[4, 4, 0, 0]} animationDuration={1500} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
