            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody>
                {data.assignments.map((assignment: any) => (
                  <tr key={assignment.id} className="border-b border-slate-800 hover:bg-slate-800/50 hover:shadow-[inset_4px_0_0_0_rgba(99,102,241,1)] transition-all duration-200">
